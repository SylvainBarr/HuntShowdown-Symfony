...
/**
 * @extends ServiceEntityRepository<AmmoType>
 *
...
class AmmoTypeRepository extends ServiceEntityRepository
{
    ...
    public function add(AmmoType $entity, bool $flush = false): void
    {
    ...
    public function remove(AmmoType $entity, bool $flush = false): void
    {
